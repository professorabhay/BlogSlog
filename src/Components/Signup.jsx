...
function Signup() {
    ...
    return (
        <div className="items-center justify-center md:min-h-[80vh] text-sm">
            <div className={`mx-auto w-full md:max-w-sm rounded-xl p-5 md:p-8 border-yellow-900 border `}>
                ...
                <form onSubmit={handleSubmit(create)} className='mt-5'>
                    <div className='space-y-4'>
                        <Input
                            ...
                            className="focus:border-solid focus:border-x-2 focus:border-customYellow"
                            {...register("name", {
                                required: true,
                            })}
                        />
                        ...
                        {loading ?
                            ...
                            :
                            <Button type="submit"
                                className="my-3 py-2 px-4 w-full text-white bg-customYellow button-Yellow rounded-lg shadow-lg hover:bg-[#f1f1f1] hover:text-black duration-400 hover:cursor-pointer"
                            >
                                Create Account
                            </Button>}
                    </div>
